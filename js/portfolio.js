...
$(window).on('load', function () {
	...
	$('.navbar-nav .nav-item:contains("PORTFOLIO")').addClass('active');
	...
	$('.review-carousel').owlCarousel({
		...
		nav: true,
		navText: [
			"<div class='prev'><i class='fa fa-angle-left'></i></div><div class='dir-text hidden-xs'>Previus</div>", 
			"<div class='next'><i class='fa fa-angle-right'></i></div><div class='dir-text hidden-xs'>Next</div>"],
		navContainer: '.custom-controls',
		autoHeight: true,
		startPosition: 1,
		rewind: true,
		navElement: 'div',
